...
export const requiredEnvVars = {
    ...
    authBaseUrl: getRequiredEnvVar('AUTH_SERVICE_BASE_URL'),
    authPort: getRequiredEnvVar('AUTH_SERVICE_PORT'),
    authPubKeyEndpoint: getRequiredEnvVar('AUTH_SERVICE_PUBLIC_KEY_PATH'),
};
